...
/**
 * Created by frankliu on 2017/11/20.
 * 状态栏颜色
 */
...
public class SystemBarTintManager {
    ...
    /**
     * Constructor. Call this in the host activityaaaa onCreate method after its
     * content view has been set. You should always create new instances when
     * the host activityaaaa is recreated.
     *
     * @param activity The host activityaaaa.
     */
    @TargetApi(19)
